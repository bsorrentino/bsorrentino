---
layout: post
title:  Skill-Based Sub-Agents with LangGraph4j and Spring AI
date:   2026-04-28
description: |
...
The repository includes an integration-style test in `SubAgentITest.java` that demonstrates this composition in a realistic flow:
...
final var result = purchaseAssistantAgent.invoke(
...
1. **The Parent Must Summarize Well**
...
2. **Tool Descriptions Matter More**
...
3. **Prompt Boundaries Need Discipline**
...
* [LangGraph4j] support interruptions in subgraph enabling **Human In The Loop** also when involving sub agents
